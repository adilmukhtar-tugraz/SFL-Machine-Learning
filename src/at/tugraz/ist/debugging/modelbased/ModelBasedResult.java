...
public class ModelBasedResult extends AlgorithmResult {
	...
	public void setRuntime(TimeSpan time) {
		this.time = time;
		this.addData("Runtime (in mircosec)", time.toString(Precision.MICROSECONDS));
	}
...
//		this.runtimeSolving = runtimeSolving;
		this.addData("Runtime Solving (in mircoseconds)", runtimeSolving.toString(Precision.MICROSECONDS));
	}
